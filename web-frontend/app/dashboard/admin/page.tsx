...
const stats = [
  { label: "Total Users", value: "—", icon: RiGroupLine },
  { label: "Active Sessions", value: "—", icon: RiCalendarLine },
  { label: "Reports", value: "—", icon: RiBarChartLine },
  { label: "Admins", value: "—", icon: RiShieldUserLine },
];
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="bg-white/5 border border-white/10 rounded-xl p-8 text-center text-slate-400">
        ...
        <p className="text-sm mt-1">This is a placeholder for the Admin panel.</p>
      </div>
    </div>
  );
}
