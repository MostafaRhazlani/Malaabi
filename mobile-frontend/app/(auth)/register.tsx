...
import { AppleLogo, TwitterLogo, Eye, EyeSlash } from "phosphor-react-native";
          ...
          <View className="flex-1 px-8 pt-16">
            ...
            <View className="w-full gap-4 mb-8">
              ...
              <View className="flex-row gap-4 w-full h-[56px]">
                <View className="flex-1 border border-gray-200 dark:border-gray-800 rounded-2xl bg-theme-light-card dark:bg-theme-dark-card justify-center">
                  <TextInput
              ...
              <View className="w-full h-[56px] border border-gray-200 dark:border-gray-800 rounded-2xl bg-theme-light-card dark:bg-theme-dark-card justify-center">
                <TextInput
                  className="px-5 text-[15px] text-gray-900 dark:text-white"
